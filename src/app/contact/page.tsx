       ...
       <div className="container">
           <div className="contact-box-cantainer">
               ...
               <h1 className="text-top-2">Contact information</h1>
                   ...
                   <div className="box-information2">
                     <p className="parent-box"> <span className="country-data">Email:</span> <span className="adrees">wasimfromkarachi@gmail.com</span></p>
                       <p className="parent-box"> <span className="country-data">Facebook:</span>  <span className="adrees">wasim akram</span></p>
                     </div>
                   </div>
                   ...
                   <div className="box-information2">
                       <p className="parent-box"> <span className="country-data">Personal:</span>  <span className="adrees">03062849737</span></p>
                      </div>
                   </div>
