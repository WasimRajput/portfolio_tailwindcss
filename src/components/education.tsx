             ...
             <div className="education-container2">
              ...
              <div className="education-box">
                ...
                <div className="left-box">
                    <h2 className="uni-name institue">Lawyer</h2>
                    <span className="uni-stu "></span> <span className="uni-date">Starting 2020, Ending 2022</span>
                </div>
                {/* right */}
                <div className="right-box">
                    <h2 className="uni-name ">L.L.B</h2>
                    <p className="uni-des "></p>
                </div>
              </div>
              <div className="education-box">
                {/* left */}
